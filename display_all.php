...
<div class="bg-light mb-5">
    <h3 class="text-center border rounded-3 border-success w-25 m-auto mt-3 shadow-lg bg-body rounded-bottom text-dark">All Products</h3>
    <!-- <p class="text-center">Everything at your convinience</p> -->
</div>
